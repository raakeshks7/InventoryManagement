...
?>
  	...
  	<?php
     	...
     	$yQuery = "SELECT cal.quarter as Quarter, SUM(sales.Dollar_Amount*sales.`Item_Count`) as Total_Sales
     	...
     	if($yPrepStmt === false) {
        	exit("Error while preparing the query to fetch data from Sales Table. ".$dbhandle->error);
     	}
     	...
     	if ($yResult) {
        	...
        	$arrData = array(
                "chart" => array(
                    "caption" => "Quarterly Sales of ".$year,
                    "paletteColors" => "#0075c2",
                    "bgColor" => "#ffffff",
                    "borderAlpha"=> "20",
                    "canvasBorderAlpha"=> "0",
	...
	// Push the data into the array
        	while($row = $yResult->fetch_array()) {
                array_push($arrData["data"], array(
              	...
              	"link" => "Sales_Drill2.php?name=".$year
              	)
           	);
        	}
           ...
           /*JSON Encode the data to retrieve the string containing the JSON representation of the data in the array. */
        	...
        	$columnChart = new FusionCharts("column2D", "Chart6" , 600, 300, "chart-6", "json", $jsonEncodedData);
  	...
  	<div id="chart-6"><!-- Fusion Charts will render here--></div>
