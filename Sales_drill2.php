...
?>
  	...
  	<?php
     	...
     	$yQuery = "SELECT cal.month as Month, SUM(sales.Dollar_Amount*sales.`Item_Count`) as Total_Sales 
	...
	// Push the data into the array
           ...
           /*JSON Encode the data to retrieve the string containing the JSON representation of the data in the array. */
        	...
        	$columnChart = new FusionCharts("column2D", "Chart7" , 600, 300, "chart-7", "json", $jsonEncodedData);
