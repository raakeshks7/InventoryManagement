...
<?php
   ...
   /*  echo "<th><form class=\"navbar-form navbar-right\" action=\"signin.php\" method=\"get\"> ";
    ...
    try {
            ...
            $query = "SELECT Order_Id,Outlet_Id,Order_Status,Timestamp FROM orders O 
                        WHERE O.Merchant_id = (SELECT Merchant_Id FROM merchant
                        WHERE username='$uname' AND pwd='$pwd') OR Merchant_Id='$Order_Id'";
