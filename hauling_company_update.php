...
{
 $query="SELECT distinct(o.Order_Status) FROM orders o,hauling_company h WHERE h.Outlet_Id=o.Outlet_Id AND Hauling_Id=".$_GET['edit_id'];
...
if(isset($_POST['btn-update']))
{
 ...
 $ps = $con->prepare($query);
 $ps->execute(); 
header("Location: Hauling_dashboard.php?edit_id=".$_GET['edit_id']); 
} 
?>
